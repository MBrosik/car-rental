	...
	>
		...
		>
			...
			{:else}
				...
				<span
					class="inline-block py-1 px-2 rounded bg-gray-800 text-gray-400 text-opacity-75 text-xs font-medium tracking-widest mr-5"
					>{userInfo1.login}</span
				>
				<!-- svelte-ignore a11y-missing-attribute -->
				<a
					class="mr-5 hover:text-white visited:text-gray-400 cursor-pointer"
					on:click={logout}
				>
					Log out
				</a>
